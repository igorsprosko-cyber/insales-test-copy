...
**Code baseline:** `9655b25c0e03bf1cf721835351b78735d2284c9f` — отдельная контрольная точка; документационные коммиты после неё не считаются изменением production/runtime code.  
